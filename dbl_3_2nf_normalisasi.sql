-- Active: 1766173374442@@127.0.0.1@3306@dbl_3_2nf_normalisasi
-- phpMyAdmin SQL Dump
-- version 5.2.1
...
--
-- Database: `dbl_2_2nf_normalisasi`
--
...
CREATE TABLE `transaksi` (
    ...
    `Shift_Karyawan` varchar(10) DEFAULT NULL,
...
CREATE TABLE `detail_transaksi` (
    ...
    `Kondisi_Barang_setelah_dikembalikan` varchar(30) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_general_ci;
...
INSERT INTO
    `detail_transaksi` (
        ...
        `Kategori_Barang`,
        `Harga_Sewa`,
        `Kondisi_Barang_setelah_dikembalikan`
    )
VALUES (
        'T-1',
        'KB-1',
